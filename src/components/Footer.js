        ...
        <footer className='footer'>
            ...
            <div className='footer__wrapper'>
                ...
                <div className='footer__social-wrapper'>
                    <a className='footer__social footer__social_facebook' href='#'></a>
                    <a className='footer__social footer__social_whats-up' href='#'></a>
                    <a className='footer__social footer__social_inst' href='#'></a>
                    <a className='footer__social footer__social_youtube' href='#'></a>
                </div>
            </div>
            <div className='footer__wrapper footer__wrapper_company-info'> 
                ...
                <p className='footer__creator'>Сайт разработан <a className='footer__link' href="https://github.com/Sepsimus/">Sepsimus</a></p>
            </div>
        </footer>
    )
}
