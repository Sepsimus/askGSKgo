    ...
    <section className="our-company">
      ...
      <div className="our-company__img">
        <div className="our-company__subtitle-wrapper">
          <p className="our-company__subtitle">
            Мы – увлеченная команда профессионалов в области оздоровления
            ...
            и не забывая о соотношении цены и качества.
          </p>
        </div>
        <div className="our-company__pagination">
          <div className="our-company__pagination-dot our-company__pagination-dot_1 our-company__pagination-dot_active" />
          <div className="our-company__pagination-dot our-company__pagination-dot_2" />
          <div className="our-company__pagination-dot our-company__pagination-dot_3" />
          <div className="our-company__pagination-dot our-company__pagination-dot_4" />
        </div>
      </div>
